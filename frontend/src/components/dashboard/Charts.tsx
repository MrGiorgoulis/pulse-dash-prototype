...
const defaultCurtailmentByEventData = [
...
export function CurtailmentByEventChart({
  ...
  data?: { event: string; kw: number }[];
}) {
  const chartData = data?.length ? data : defaultCurtailmentByEventData;
  return (
    <div className="bg-card rounded-xl border border-border p-5">
      <h3 className="text-sm font-semibold text-card-foreground mb-4">
...
export function AssetHealthChart({
  ...
  const chartData = data?.length ? data : defaultAssetHealthData;
  return (
    <div className="bg-card rounded-xl border border-border p-5">
      <h3 className="text-sm font-semibold text-card-foreground mb-4">
